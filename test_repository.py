...
def insert_order_line(session) -> str | None:
    session.execute(
...
def insert_batch(session, batch_id) -> str | None:
    session.execute(
...
def test_repository_can_retrieve_a_batch_with_allocations(session) -> None:
